...
{
	echo  '<li class="breadcrumb-item" typeof="v:Breadcrumb"><a href="'.BASE_PATH_HREF.'" rel="v:url" property="v:title">'.$this->diafan->_('Главная').'</a></li>';
}
if ($this->diafan->_site->parent_id)
{
	foreach ($page["breadcrumb"] as $row)
	{
		echo '<li class="breadcrumb-item" typeof="v:Breadcrumb"><a href="'.BASE_PATH_HREF.$row["link"].'" rel="v:url" property="v:title">'.$this->diafan->_useradmin->get($row["name"], 'name', $row["id"], 'site', _LANG).'</a></li>';
	}
}
if ($this->diafan->_site->breadcrumb)
{
	foreach ($this->diafan->_site->breadcrumb as $breadcrumb)
	{
		...
		echo '<li class="breadcrumb-item" typeof="v:Breadcrumb"><a href="'.BASE_PATH_HREF.$breadcrumb["link"].'" rel="v:url" property="v:title">'.$breadcrumb["name"].'</a></li>';
	}
}
if($current)
{
	...
	echo ' <li class="breadcrumb-item active" typeof="v:Breadcrumb">'.$name.'</li>';
}
echo '</ol>';